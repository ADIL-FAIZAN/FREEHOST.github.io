...
setbtn("Enable Dark Mode"); 
  ...
  <div className="card" style={myStyle}>
    <div className="card-header" id="headingOne">
      <h5 className="mb-0">
        <button className="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" style={myStyle} aria-controls="collapseOne">
...
<button className="btn btn-primary my-3" onClick={Mode} style={myStyle} >{btn}</button>
